...
class MY_Model extends CI_Model {
     ...
     * o índice que foi alterado (quando for update), ou false (em caso de falha)
     */
    ...
    /**
     * Deleta registros da tabela a partir de uma cláusula "where"
     * @param array|string $where O filtro utilizado para a exclusão
     * @return boolean <b>True</b> caso não haja erros, <b>False</b> em caso contrário
     */
