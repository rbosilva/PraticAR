<div role="tabpanel" class="tab-pane <?php echo $sequencia == 1 ? 'active' : ''; ?>" id="tab-exercicio<?php echo $sequencia; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <textarea id="descricao<?php echo $id; ?>" class="form-control" rows="4"
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 operacoes">
            ...
            ?>
            <br>
            <textarea id="resposta<?php echo $id; ?>" name="resposta[<?php echo $id; ?>][ra]" class="form-control resposta" rows="4"
            ...
            <textarea id="sql<?php echo $id; ?>" name="resposta[<?php echo $id; ?>][sql]" tabindex="-1"
                class="form-control sql" rows="4" style="resize: none; margin-top: 4px;" spellcheck="false"
