...
<a aria-role="button" type="button" class="btn btn-default" title="Divisão (NORMAL / <b style='color: blue;'>PROJEÇÃO</b>)" data-operacao="÷"
   data-toggle="popover" data-content="relA <b style='color: red;'>÷</b> (relA.col = relB.col) relB<br>
   <b style='color: blue;'>π col</b> <b style='color: blue;'>(</b>relA<b style='color: blue;'>)</b> <b style='color: red;'>÷</b> (relA.col = relB.col) relB">÷</a>
...
<a aria-role="button" type="button" class="btn btn-default" title="Renomear (TABELA / <b style='color: blue;'>COLUNA(S)</b>)"
   data-operacao="ρ" data-toggle="popover" data-content="<b style='color: red;'>ρ</b> alias (rel)<br>
   <b style='color: red;'>ρ</b> <b style='color: blue;'>[alias1, alias2] (π col1, col2</b> (rel)<b style='color: blue;'>)</b>">ρ</a>
